export const PAPER_OU_OPPOSITE_LINE_VERSION = 'v7.0-r4.10.2.11.5-ou-opposite-protected-line-v1';
...
export function mapPaperOuPredictionToOppositeLine(input: {
  ...
  return {
    ...
    recommendedMarketType: paperOuMarketForLine(recommendedLineValue),
    recommendedSelection,
    recommendedLineValue,
    lineShiftGoals: recommendedLineValue === input.predictionLineValue ? 0 : 1,
    boundaryClamped: recommendedLineValue === input.predictionLineValue,
    paperOnly: true,
  };
}
