...
# PredictionAI Automatic Pipeline installer v1.4 - structure-based API admin anchor
...
$transformer = Join-Path $PSScriptRoot 'predictionai-automatic-pipeline-v1.4-transform.mjs'
