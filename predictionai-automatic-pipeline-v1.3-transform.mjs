...
function fail(message) {
  throw new Error(`[automatic-pipeline-v1.3] ${message}`);
}
...
console.log('PREDICTIONAI_AUTOMATIC_PIPELINE_V1_3_TRANSFORM_PASS');
