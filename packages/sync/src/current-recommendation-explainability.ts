// R4.10.2.10_SHADOW_CANDIDATE_LEDGER_BETA2A: live API exposes research-only shadow classification.
import {
...
export function attachCurrentRecommendationExplainability<T extends AnyRecord>(payload: T, analysis: unknown): T & AnyRecord {
  ...
  return {
    ...
    currentShadowCandidateDecision: selectCurrentShadowCandidate(candidates),
