...
export const CURRENT_SCIENTIFIC_RECOMMENDATION_VERSION =
  'v7.0-r4.10.2.6-current-scientific-recommendation-v4';
...
function compareCurrentCandidates(
  ...
  return compareRiskAdjustedCurrentCandidates(
    left,
    right,
  );
}
...
export function buildNoProviderFixtureSnapshotAnalysis(
  input: {
    providerFixtureId: number;
    kickoffAt: Date;
    now: Date;
  ...
  return emptyAnalysis({
    ...
    status:
      'NO_PROVIDER_FIXTURE_SNAPSHOT',
    error:
      'NO_PROVIDER_FIXTURE_SNAPSHOT_AT_CURRENT_AS_OF',
  });
}
...
> {
  ...
  for (
    ...
    try {
      ...
      const quoteConsensusBySelection =
        buildCurrentQuoteConsensusMap(
          fixtureOdds.map(
            (
              row: LiveOddsRow,
            ...
            (
              ...
              const riskAssessment =
                assessRiskAdjustedCurrentCandidate({
                  ...
                  fairMarketProbability:
                    candidate.fairMarketProbability,
                  rawEdge:
                    scientific.edge,
                  rawExpectedValue:
                    scientific.expectedValue,
                  reliabilityStatus:
                  ...
                  minimumOdds:
                    SCIENTIFIC_BEST_BET_POLICY.minimumOdds,
                  minimumEdge:
                    SCIENTIFIC_BEST_BET_POLICY.minimumEdge,
                  minimumExpectedValue:
                    SCIENTIFIC_BEST_BET_POLICY.minimumExpectedValue,
                  quoteConsensus:
                    resolveCurrentQuoteConsensus({
                      groupedOdds:
                        quoteConsensusBySelection,
                      quote,
                    }),
                });
              ...
              return {
                ...
                rawSignalEligibleBeforeRiskGuard:
                  rawCurrentSignal.eligible,
                rawSignalRejectionReasons:
                  rawCurrentSignal.reasons,
                rankingVersion:
                  riskAssessment.rankingVersion,
                signalTier:
                  riskAssessment.signalTier,
                effectiveModelWeight:
                  riskAssessment.effectiveModelWeight,
                adjustedModelProbability:
                  riskAssessment.adjustedModelProbability,
                probabilityHaircut:
                  riskAssessment.probabilityHaircut,
                conservativeProbability:
                  riskAssessment.conservativeProbability,
                conservativeEdge:
                  riskAssessment.conservativeEdge,
                conservativeExpectedValue:
                  riskAssessment.conservativeExpectedValue,
                longshotPenalty:
                  riskAssessment.longshotPenalty,
                riskAdjustedScore:
                  riskAssessment.riskAdjustedScore,
                quoteCount:
                  riskAssessment.quoteCount,
                quoteMedianOdds:
                  riskAssessment.quoteMedianOdds,
                quoteAgreementRatio:
                  riskAssessment.quoteAgreementRatio,
                quoteDeviationRatio:
                  riskAssessment.quoteDeviationRatio,
                quoteOutlier:
                  riskAssessment.quoteOutlier,
                reliabilityStatus:
                  candidate
                    .reliabilityStatus,
                modelSource:
                ...
                currentSignalEligible:
                  riskAssessment.eligible,
                currentSignalRejectionReasons:
                  riskAssessment.rejectionReasons,
                officialEligible,
          ...
          : {
              ...
              expectedValue:
                selected
                  .expectedValue,
              rankingVersion:
                selected.rankingVersion,
              signalTier:
                'RISK_ADJUSTED_RESEARCH' as const,
              effectiveModelWeight:
                selected.effectiveModelWeight,
              adjustedModelProbability:
                selected.adjustedModelProbability,
              probabilityHaircut:
                selected.probabilityHaircut,
              conservativeProbability:
              ...
              longshotPenalty:
                selected.longshotPenalty,
              riskAdjustedScore:
                selected.riskAdjustedScore,
              quoteCount:
                selected.quoteCount,
              quoteMedianOdds:
                selected.quoteMedianOdds,
              quoteAgreementRatio:
                selected.quoteAgreementRatio,
              quoteDeviationRatio:
                selected.quoteDeviationRatio,
              quoteOutlier:
                false as const,
              reliabilityStatus:
                selected
