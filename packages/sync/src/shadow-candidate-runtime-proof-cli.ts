...
interface SnapshotAnalysisCandidate {
  marketType?: string;
  selection?: string;
...
interface SnapshotPayload {
  ...
  analysis?: {
    candidates?: SnapshotAnalysisCandidate[];
  };
  integrity?: {
    appendOnly?: boolean;
  ...
  const matchingCandidate =
    selected == null
      ...
      : (
          ...
          (
            candidate: SnapshotAnalysisCandidate,
          ): boolean =>
