...
# PredictionAI Automatic Pipeline installer v1.3 - cron-owned startup, no brittle setTimeout anchor
...
$transformer = Join-Path $PSScriptRoot 'predictionai-automatic-pipeline-v1.3-transform.mjs'
